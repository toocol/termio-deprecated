 ...
 */
jstring stringC2J(JNIEnv *env, const char *s) { return env->NewStringUTF(s); }
...
inline JNIEnv *attachThread(JavaVM *javaVM) {
  ...
  int result = javaVM->AttachCurrentThread((void **)(localEnvPtrPtr), NULL);
...
inline JNIEnv *getEnv(JavaVM *javaVM) {
  ...
  jint result = javaVM->GetEnv((void **)(localEnvPtrPtr), JNI_VERSION_1_2);
