...
#include <jni.h>
/* Header for class com_toocol_termio_utilities_jni_TermioJNI */

#ifndef _Included_com_toocol_termio_utilities_jni_TermioJNI
#define _Included_com_toocol_termio_utilities_jni_TermioJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
