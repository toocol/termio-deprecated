...
#define _REENT_INIT(var)                                                     \
  {                                                                          \
    0, &__sf[0], &__sf[1], &__sf[2], 0, _NULL, 0, 0, _NULL, _NULL, _NULL, 0, \
        0, _NULL, _NULL, _NULL, _NULL, _NULL,                                \
        _REENT_INIT_ATEXIT{_NULL, 0, _NULL}, _NULL, _NULL, _NULL             \
  }
...
#define _REENT_INIT(var)                                                     \
  {                                                                          \
    0, (__FILE *)&__sf_fake_stdin, (__FILE *)&__sf_fake_stdout,              \
        (__FILE *)&__sf_fake_stderr, 0, _NULL, 0, 0, _NULL, _NULL, _NULL, 0, \
        0, _NULL, _NULL, _NULL, _NULL, _NULL,                                \
        _REENT_INIT_ATEXIT{_NULL, 0, _NULL}, _NULL, _NULL, _NULL             \
  }
...
#define __reent_assert(x)                             \
  ((x) ? (void)0                                      \
       : __assert_func(__FILE__, __LINE__, (char *)0, \
