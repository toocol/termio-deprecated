...
use platform::{
    ...
    ACTION_HIDE_LEFT_SIDE_BAR, ACTION_NEW_SESSION_CREDENTIAL_DIALOG,
    ACTION_TOGGLE_SESSION_MANAGEMENT_PANEL,
};
...
impl TermioCommunityWindow {
    ...
    pub fn setup_actions(&self) {
        ...
        let action_add_session_credential =
            SimpleAction::new(ACTION_ADD_SESSION_CREDENTIAL.create(), Some(VariantTy::TUPLE));
        ...
        action_create_ssh_session.connect_activate(clone!(@weak self as window => move |_, parameter| {
            let param = parameter
                    .expect("Could not get parameter.")
