...
class TerminalCharacterDecoder {
 public:
   ...
   * text string and writes the string into an output QTextStream.
   *
   * @param characters An array of characters of length @p count.
   * @param count The number of characters
   * @param properties Additional properties which affect all characters in the
   * line
   */
...
class PlainTextDecoder : public TerminalCharacterDecoder {
 public:
   ...
   * at which new lines where added.  Returns an empty if
...
class HTMLDecoder : public TerminalCharacterDecoder {
 public:
  ...
  /**
   * Sets the colour table which the decoder uses to produce the HTML colour
   * codes in its output
   */
