 ...
 * @version: 0.0.1
 */
class TrySshSessionSync(val sessionId: Long = 0, val host: String, val user: String, val password: String) : SyncEvent()

class TrySshSessionAsync(val sessionId: Long = 0) : AsyncEvent()
