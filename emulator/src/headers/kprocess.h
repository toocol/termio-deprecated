...
class KProcess : public QProcess {
 ...
 public:
  ...
  enum OutputChannelMode {
    ...
    OnlyStderrChannel /**< Only standard error is handled; standard output is
                         forwarded */
  };
   ...
   *  otherwise its exit code
   */
  static int execute(const QString &exe,
                     const QStringList &args = QStringList(), int msecs = -1);
   ...
   * @return the PID of the started process or 0 on error
   */
  static int startDetached(const QString &exe,
